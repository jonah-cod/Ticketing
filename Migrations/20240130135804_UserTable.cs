...
namespace _.Migrations
{
    ...
    public partial class UserTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FullNames", "JoinedAt", "Password", "UpdatedOn" },
                values: new object[] { 1, "thisisjohn@doe.com", "John Doe", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Plain password", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
        }
